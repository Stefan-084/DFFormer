...
from basicsr.data import create_dataloader, create_dataset  # noqa: E402
from basicsr.data.data_sampler import EnlargedSampler  # noqa: E402
from basicsr.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher  # noqa: E402
from basicsr.models import create_model  # noqa: E402
from basicsr.utils import (  # noqa: E402
    MessageLogger,
    check_resume,
    get_env_info,
    get_root_logger,
...
from basicsr.utils.dist_util import get_dist_info, init_dist  # noqa: E402
from basicsr.utils.options import dict2str, parse  # noqa: E402
...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        "-opt",
        type=str,
        default=None,  # need to be specified when running train.py
        help="Path to option YAML file.",
    )
    parser.add_argument(
        "--launcher", choices=["none", "pytorch", "slurm", "deepspeed"], default="none", help="job launcher"
    )
